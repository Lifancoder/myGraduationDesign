    ...
    <div class="image_mask">
      <div class="image_center">
        ...
        <div class="login_mask">
          <span class="login_text">修改密码</span>
          <div class="login_content">
            ...
            <el-input class="recharge_input_verification" v-model="pwd" placeholder="请输入密码" show-password></el-input>
            <div style="height: 20px;width: 80%;margin-top: 30px">
              <i class="my-iconzaicishurumima"  ></i><span class="login_content_text ">确认密码</span>
            </div>
            <el-input class="recharge_input_verification" v-model="confirmPwd" placeholder="再次输入密码" show-password></el-input>
            <el-button  @click="changeSuccess">确认修改</el-button>
          </div>
...
<style scoped>
  ...
  .recharge_input_verification >>>.el-input__inner{
    -webkit-appearance: none;
    background-color: rgba(255, 255, 255, 0);
    background-image: none;
    border-radius:0;
  ...
  .VerificationCode_button /deep/.el-button{
    width: 50% !important;
    display: inline-block;
